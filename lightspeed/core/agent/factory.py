...
class AgentFactory:
    ...
    def create_agent(
        *,
        ...
        and configured safety shields as safety capabilities (see
        :class:`~lightspeed.core.agent.safety.factory.SafetyCapabilityFactory`),
        ...
        capabilities.extend(
            SafetyCapabilityFactory.build_capabilities(configuration.configuration.safety)
        )
